...
SELECT K.MaKH, K.TenKH FROM KHACHHANG AS K, TAIKHOANDANGNHAP AS T WHERE K.MaKH = T.MaKH AND K.TenKH = T.TenTK

SELECT TenTK, MK FROM TAIKHOANDANGNHAP WHERE Email = 'hai@gmail.com'
...
WHERE T.MaTK = TK.MaTK AND TK.MaKH = K.MaKH AND K.MaKH = 'KH2867')

DELETE GIAODICH WHERE MaGD IN (SELECT MaGD FROM THONGTINTAIKHOAN AS TK, KHACHHANG AS K, GIAODICH AS G 
WHERE G.SoTKNhan = TK.SoTK AND TK.MaKH = K.MaKH AND K.MaKH = 'KH2867')